...
if (isset($_GET['search'])) {
    ...
    // filtering the learning paths based on the search term
...
// applying additional filters for category and language
if (isset($_GET['category']) && $_GET['category'] !== "") {
    $categoryFilter = $_GET['category'];
    $filteredLps = array_filter($filteredLps, function ($lp) use ($categoryFilter) {
        return $lp['category'] == $categoryFilter;
    });
}

if (isset($_GET['language']) && $_GET['language'] !== "") {
    $languageFilter = $_GET['language'];
    $filteredLps = array_filter($filteredLps, function ($lp) use ($languageFilter) {
        return $lp['language'] == $languageFilter;
    });
}
?>
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="img/logo.jpg"></head>
